                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @elseif($item->job_status == 3)
                                            <small><i class="fas fa-dot-circle text-success"></i></small> Complete
                                        @endif
                                    </td>
                                    <td>
                                        <div class="btn-group dropleft">
                                            ...
                                            <div class="dropdown-menu">
                                                ...
                                                <a class="dropdown-item" href="{{route('pause-job', $item->id)}}"><small><i class="fas fa-pause"></i> </small> Pause</a>
                                            </div>
                                          </div>
                                    </td>
                                </tr>
